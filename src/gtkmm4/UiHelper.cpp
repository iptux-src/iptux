...
//     auto tpixbuf = *pixbuf;
//     *pixbuf =
//         gdk_pixbuf_scale_simple(tpixbuf, _width, _height,
//         GDK_INTERP_BILINEAR);
...
//   gtk_drag_dest_set(widget, GTK_DEST_DEFAULT_ALL, &target, 1,
//   GDK_ACTION_MOVE);
// }
...
//                                        bool sensitive) {
//   GAction* action = g_action_map_lookup_action(G_ACTION_MAP(map),
//   action_name); if (!action) {
//     return;
//   }
