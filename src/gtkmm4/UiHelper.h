...
// void pop_info(GtkWidget* parent, const gchar* format, ...) G_GNUC_PRINTF(2,
// 3); void pop_warning(GtkWidget* parent, const gchar* format, ...)
//     G_GNUC_PRINTF(2, 3);
...
// GActionEntry makeParamActionEntry(const std::string& name, GActionCallback f,
// const std::string& paramType); GActionEntry makeStateActionEntry(const
// std::string& name,
//                                   GActionCallback f,
