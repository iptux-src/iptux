 ...
 * @return UI参考数据
 */
const RecvFileDataPara& RecvFileData::GetTransFilePara() const { return para; }
...
RecvFileDataPara& RecvFileDataPara::setStatus(const std::string& value) {
  status = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setTask(const std::string& value) {
  task = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setPeer(const std::string& value) {
  peer = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setIp(const std::string& value) {
  ip = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setFilename(const std::string& value) {
  filename = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setFileLength(const std::string& value) {
  fileLength = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setFinishLength(const std::string& value) {
  finishLength = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setProgress(double value) {
  progress = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setCost(const std::string& value) {
  cost = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setRemain(const std::string& value) {
  remain = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setRate(const std::string& value) {
  rate = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setFilePath(const std::string& value) {
  filePath = value;
  return *this;
}

RecvFileDataPara& RecvFileDataPara::setData(RecvFileData* value) {
  data = value;
  return *this;
}

const std::string& RecvFileDataPara::getStatus() const {
  return status;
}

const std::string& RecvFileDataPara::getTask() const {
  return task;
}

const std::string& RecvFileDataPara::getPeer() const {
  return peer;
}

const std::string& RecvFileDataPara::getIp() const {
  return ip;
}

const std::string& RecvFileDataPara::getFilename() const {
  return filename;
}

const std::string& RecvFileDataPara::getFileLength() const {
  return fileLength;
}

const std::string& RecvFileDataPara::getFinishLength() const {
  return finishLength;
}

double RecvFileDataPara::getProgress() const {
  return progress;
}

const std::string RecvFileDataPara::getProgressText() const {
...
const std::string& RecvFileDataPara::getCost() const {
  return cost;
}

const std::string& RecvFileDataPara::getRemain() const {
  return remain;
}

const std::string& RecvFileDataPara::getRate() const {
  return rate;
}

const std::string& RecvFileDataPara::getFilePath() const {
  return filePath;
}

RecvFileData* RecvFileDataPara::getData() const {
  return data;
}
